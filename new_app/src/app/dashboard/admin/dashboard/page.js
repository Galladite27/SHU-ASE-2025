...
// --- DUMMY DATA FOR ADMIN (SPECIFIC BRANCH????) ---
const adminSummary = {
  newUsersToday: 3,
  staffMembers: 22,
...
const newUsersToday = [
  { id: 'INC-101', donorName: 'Alice Johnson', location: 'Reading'},
  { id: 'INC-102', donorName: 'Charlie Brown', location: "Leicester"},
  { id: 'INC-103', donorName: 'Diana Prince', location: "Sheffield"},
  { id: 'INC-104', donorName: 'Bob Williams', location: "Manchester"},
  { id: 'INC-105', donorName: 'Ethan Hunt', location: "London"},
];
    ...
    <main className="p-6 sm:p-8 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <DashboardCard title="Pending Donations" value={adminSummary.newUsersToday} />
          <DashboardCard title="Total Items in Stock" value={adminSummary.itemsInStock} />
          <DashboardCard title="Donors This Month" value={adminSummary.donorsThisMonth} />
        </div>
